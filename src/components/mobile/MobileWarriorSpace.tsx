  ...
  return (
    <div className="mobile-smooth-scroll mobile-gpu-boost min-h-screen bg-gradient-to-br from-background via-primary/5 to-purple-500/10 lg:hidden">
      ...
      <main className="pt-20 pb-20 mobile-container space-y-6">
        ...
        <div className="mobile-card bg-gradient-to-br from-primary/10 via-purple-500/5 to-transparent border-primary/20 relative overflow-hidden rounded-2xl p-6">
          ...
          <div className="relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center mobile-gpu-boost">
        ...
        {/* Tab navigation */}
        <div className="flex bg-muted/30 rounded-2xl p-1 mobile-gpu-boost">
          {[
            ...
            return (
              <Button
                ...
                className={cn(
                  "flex-1 touch-target gap-2 rounded-xl",
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6 animate-mobile-fade-in">
            {/* Daily progress */}
            <div className="mobile-card rounded-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              {quickActions.map((action, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="mobile-card rounded-2xl p-4 touch-feedback cursor-pointer"
        ...
        {activeTab === 'quests' && (
          <div className="space-y-4 animate-mobile-fade-in">
            ...
            {todayQuests.map((quest) => (
              <div key={quest.id} className={cn(
                "mobile-card rounded-2xl p-4 touch-feedback transition-all duration-200",
                quest.completed && "bg-muted/30 opacity-75"
              )}>
                <div className="flex items-center gap-3">
                  <div className={cn(
                    "w-6 h-6 rounded-full border-2 flex items-center justify-center mobile-gpu-boost",
                    quest.completed 
        ...
        {activeTab === 'stats' && (
          <div className="grid grid-cols-2 gap-4 animate-mobile-fade-in">
            {[
              ...
              return (
                <div key={index} className="mobile-card touch-feedback mobile-hover:scale-105 rounded-2xl p-4 text-center animate-mobile-fade-in"
                     style={{ animationDelay: `${index * 100}ms` }}>
                  <Icon className={cn("h-6 w-6 mx-auto mb-2 mobile-gpu-boost", stat.color)} />
