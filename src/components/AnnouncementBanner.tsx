...
const AnnouncementBanner: React.FC<AnnouncementProps> = ({ announcement }) => {
  ...
  return (
    <div className="relative mb-4 p-4 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-200/50 dark:border-purple-900/30 rounded-lg backdrop-blur-sm shadow-sm animate-fade-in">
