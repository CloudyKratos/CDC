...
-- Drop the additional policies mentioned in the error
DROP POLICY IF EXISTS "Users can view channel members for public channels" ON public.channel_members;
DROP POLICY IF EXISTS "Users can view messages in public channels" ON public.community_messages;
DROP POLICY IF EXISTS "Users can send messages to public channels" ON public.community_messages;
